...
export default function Students() {
    ...
    const onSubmit = () => {
        console.log(name, removerCaracteresEspeciais(document), email, removerCaracteresEspeciais(phone), converterDate(birthday), height, weight, shoes, password, contract, frequency, false, '', status)
        setLoading(true);
